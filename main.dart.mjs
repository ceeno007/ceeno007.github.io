...
_1826: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1827: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1829: (s, m) => {
          try {
...
_1874: l => arrayFromDartList(Uint8Array, l),
...
_1884: stringFromDartString,
_1885: stringToDartString,
_1886: () => ({}),
_1887: () => [],
_1888: l => new Array(l),
_1889: () => globalThis,
_1890: (constructor, args) => {
...
_1892: (o, p) => o[p],
_1893: (o, p, v) => o[p] = v,
_1894: (o, m, a) => o[m].apply(o, a),
_1896: o => String(o),
_1897: (p, s, f) => p.then(s, f),
_1898: s => {
...
_1941: x0 => x0.matches,
_1945: x0 => x0.platform,
_1950: x0 => x0.navigator,
